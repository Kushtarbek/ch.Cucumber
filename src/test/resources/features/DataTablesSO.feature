...
Feature: Testing datatables website
  ...
  Scenario outline : Testing adding new employee to the table  // TODO Outline
   ...
   Examples: Test data for datatables
    ...
    |john     |doe     |retired |london|314      |2019-01-12|125000|
    |joe      |wong    |working |chicago|312     |2019-11-01|150000|
    |adam     |sandler |actor   |cali   |310     |2015-10-10|250000|
#    |jean     |burgin |actress   |cali   |310     |2015-10-10|250000|
#    |mudit      |sanglar |manager   |boston |617     |2014-09-10|100000|
